...
import 'package:mobile_servies/tech/view/profile/aboutUS.dart';
import 'package:mobile_servies/tech/view/profile/privacyPolicy.dart';
...
class AssistiveTouchFab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<UserAuthProvider>(builder: (context, value, child) {
