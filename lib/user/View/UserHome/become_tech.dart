...
class BecomeTechPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => TechnicianApplicationProvider(),
      child: Scaffold(
        backgroundColor: const Color(0xFF718355),
        body: Consumer<TechnicianApplicationProvider>(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Gap(5),
                                TechTextField(
                                  "e.g., Smartphone Repair, Laptop Repair",
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    const Gap(10),
                                    Text(
                                      provider.resumePath != null ? "Resume uploaded" : "Click to upload Resume",
                                      style: GoogleFonts.poppins(
                                        color: const Color(0xFF5A5A5A),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w500,
                          ...
                          if (provider.errorMessage != null) ...[
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.openSans(
                                  color: provider.errorMessage!.contains('Technician') ? Colors.green : Colors.red,
                                  fontSize: 14,
                                ),
                              ),
                            ),
                            ...
                            child: ElevatedButton(
                              onPressed: provider.isLoading
                                  ...
                                  : () async {
                                      ...
                                      if (success && provider.errorMessage!.contains('Technician')) {
                                        // If approved, redirect to login to enforce Technician Portal
