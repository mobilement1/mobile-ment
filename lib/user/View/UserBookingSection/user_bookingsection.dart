    ...
    color: Colors.white,
      ...
      body: Padding(
        ...
        child: Container(
          ...
          height: 650,
          decoration: BoxDecoration(gradient: LinearGradient(colors: [Color.fromARGB(255, 65, 46, 105), Color.fromARGB(255, 71, 58, 116)],begin: Alignment.bottomCenter,end:Alignment.topCenter )),
