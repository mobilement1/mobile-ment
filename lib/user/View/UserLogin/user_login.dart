                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: const LinearGradient(
                              colors: [Colors.green, Color.fromARGB(255, 41, 41, 41)],
                            ),
                          ),
                          child: Material(
                                    ...
                                    switch (authProvider.userRole) {
                                      case 'Admin':
                                        Navigator.pushReplacement(
                                          context,
                                          MaterialPageRoute(builder: (ctx) => Dashbordpage()),
                                        );
                                        break;
                                      case 'Technician':
                                        Navigator.pushReplacement(
                                          context,
                                          MaterialPageRoute(builder: (ctx) => BottomNavTech()),
                                        );
                                        break;
                                      default:
                                        Navigator.pushReplacement(
                                          context,
                                          MaterialPageRoute(builder: (ctx) => UserBottom()),
                                        );
                                    }
                                  } else {
                                    ScaffoldMessenger.of(context).showSnackBar(
